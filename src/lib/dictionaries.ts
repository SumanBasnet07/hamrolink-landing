...
export const dictionaries = {
  ...
  en: {
    ...
    transformation: {
      ...
      subtext: "Typical outcomes for Nepali businesses moving their operations to HamroLink Digital.",
      items: [
        {
...
Because in the AI era, looking professional isn't optional anymore. It's survival.`,
  ...
  ne: {
    ...
    transformation: {
      ...
      subtext: "HamroLink Digital मा आबद्ध भएपछि नेपाली व्यवसायहरूमा देखिने स्वाभाविक परिवर्तनहरू।",
      items: [
        {
