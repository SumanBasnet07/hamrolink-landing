      ...
      plans: [
        ...
        },
        {
          ...
          feats: [
            ...
            { t: "250 bookings · 50 events", ok: true },
...
Because in the AI era, looking professional isn't optional anymore. It's survival.`,
    ...
    footer: {
      ...
      businessName: "हाम्रोलिङ्क डिजिटल (HamroLink Digital)",
      address: "Pakhribas-04, Dhankuta, Koshi Province, Nepal",
      regIdLabel: "Reg No",
      regIdValue: "ध-९४५८/०८२/०८३",
      panLabel: "PAN",
      panValue: "६२३२५११९१",
      authorityLabel: "Registering Authority",
      authorityValue: "Cottage & Small Industry Office, Dhankuta",
...
किनकि एआईको यो युगमा, प्रोफेसनल देखिनु अब कुनै विकल्प (Option) होइन, यो व्यवसाय बचाउने (Survival) आधार हो।`,
    ...
    footer: {
      ...
      panLabel: "प्यान नं",
      panValue: "६२३२५११९१",
      authorityLabel: "दर्ता गर्ने निकाय",
      authorityValue: "घरेलु तथा साना उद्योग कार्यालय, धनकुटा",
