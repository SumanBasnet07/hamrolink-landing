"use client";
// app/admin/blog/page.tsx — admin blog list
      ...
      <div className="max-w-6xl mx-auto px-8 py-6">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-20 text-center">
            ...
            <Link href="/admin/blog/new" className="mt-4 inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-bold hover:bg-indigo-500 transition-colors">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-3 text-gray-500 text-xs">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {post.approvedCount}/{post.commentCount}
                        </span>
                      </div>
                    </td>
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        {post.published && (
                          <Link href={`/en/blog/${post.slug}`} target="_blank"
                            className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors" title="View live">
                            <Globe className="w-4 h-4 text-gray-400"/>
                          </Link>
                        )}
                        <Link href={`/admin/blog/${post._id}`}
                          className="p-1.5 hover:bg-indigo-50 rounded-lg transition-colors" title="Edit">
                          <Edit2 className="w-4 h-4 text-indigo-500"/>
                        </Link>
                        <button
                          onClick={() => handleDelete(post._id, post.title_en)}
